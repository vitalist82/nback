export class GameResult {
    ...
    public get generalMatchPercentage():number {
        return Math.round((this.audioMatchCount + this.positionMatchCount) / this.trialsCount / 2 * 1000) / 10;
    }
    ...
    public constructor(trialsCount:number, audioMatchCount:number, positionMatchCount:number) {
